...
$headTitle = '社員登録';
$errors = [];
$inputValues = EMPLOYEE_ELEMENTS + COMMON_ELEMENTS;
...
<body>
    ...
    <section class="main">
        ...
        <form action="register.php?company_id=<?php echo h($companyId); ?>" method="post" enctype="application/x-www-form-urlencoded">
            <table>
                <tr>
                    <th>社員名</th>
                    <td>
        ...
        <p class="back-page"><a href="index.php?company_id=<?php echo h($companyId); ?>">社員一覧へ</a></p>
